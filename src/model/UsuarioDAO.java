...
public class UsuarioDAO {
    ...
    public boolean insert(Usuario usuario) throws SQLException{
        ...
        String sqlInsert = "insert into usuario (nome, cpf, email, telefone, cargo) values (?, ?, ?, ?, ?)";
        PreparedStatement statementInsert = connection.prepareStatement(sqlInsert);
        statementInsert.setString(1, usuario.getNome());
        statementInsert.setString(2, usuario.getCpf());
        statementInsert.setString(3, usuario.getEmail());
    ...
    public void update(Usuario usuario) throws SQLException{
        ...
        String sql = "update usuario set nome = ?, cpf = ?, email = ?, telefone = ?, cargo = ? where id = ?";
    ...
    private ArrayList<Usuario> pesquisa(PreparedStatement statement) throws SQLException {
        ...
        while (resultSet.next()){
            ...
            Usuario objUsuario = new Usuario(id, nome, cpf, email, telefone, cargo);
    ...
    public boolean autenticarInsert(Usuario usuario) throws SQLException {
        String sql = "select * from usuario where cpf = ? or email = ? or telefone = ?";
        PreparedStatement statement = connection.prepareStatement(sql);
        statement.setString(1, usuario.getCpf());
        statement.setString(2, usuario.getEmail());
